...
Progressive loading documentation system for jp-go-errors package.
...
- Specific to jp-go-errors package only
...
- Usage guide: `common/standards/go/jp-go-errors.md` (how to USE this package)
